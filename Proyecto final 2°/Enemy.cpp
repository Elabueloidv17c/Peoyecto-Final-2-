...
void Enemy::Response(vector <string> words, string enemyNames[5], Player &hero, vector <Enemy*> enemies)
{
	...
	{
	case 1:
		if (enemies[0]->m_active == 1 && enemies[0]->m_alive == 1)
		{
		...
		break;
	case 4:
		if (enemies[1]->m_active == 1 && enemies[1]->m_alive == 1)
		{
		...
		break;
	case 7:
		if (enemies[2]->m_active == 1 && enemies[2]->m_alive == 1)
		{
		...
		break;
	case 8:
		if (enemies[3]->m_active == 1 && enemies[3]->m_alive == 1)
		{
		...
		break;
	case 10:
		if (enemies[4]->m_active == 1 && enemies[4]->m_alive == 1)
		{
		...
		break;
	case 11:
		if (enemies[5]->m_active == 1 && enemies[5]->m_alive == 1)
		{
		...
		break;
	case 12:
		if (enemies[6]->m_active == 1 && enemies[6]->m_alive == 1)
		{
		...
		break;
	case 13:
		if (enemies[0]->m_active == 1 && enemies[7]->m_alive == 1)
		{
		...
		break;
	case 15:
		if (enemies[8]->m_active == 1 && enemies[8]->m_alive == 1)
		{
